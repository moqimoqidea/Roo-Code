export const EXTEND_ANTHROPIC_TOOLS = [
  {
    ...
    "input_schema": {
      ...
      "properties": {
        "args": {
          "type": "array",
          "description": "A list of file objects to read. Each object must contain a 'path'. A maximum of 5 files can be read at once.",
          "items": {
            "type": "object",
            "properties": {
              "path": {
  ...
  },
  {
    ...
    "input_schema": {
      ...
      "properties": {
        "path": {
          "type": "string",
          "description": "The path of the directory to search in (relative to the current workspace directory). This directory will be recursively searched."
        },
        "regex": {
          "type": "string",
  ...
  },
  {
    ...
    "input_schema": {
      ...
      "properties": {
        ...
        "url": {
          "type": "string",
          "description": "The URL for the 'launch' action (e.g. http://localhost:3000, file:///path/to/file.html)."
        },
        "coordinate": {
          "type": "string",
  ...
  },
  {
    ...
    "input_schema": {
      ...
      "properties": {
        ...
        "follow_up": {
          "type": "array",
          "description": "A list of 2-4 suggested answers that logically follow from the question. Each suggestion should be specific, actionable, and a complete answer.",
          "items": {
            "type": "object",
            "properties": {
              "suggest": {
